    ...
    <div className="min-h-screen bg-[#050a18]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-16 sm:py-24">
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-purple-400 transition-colors mb-10"
          >
                          ...
                          <thead>
                            <tr className="border-b border-slate-700">
                              {section.table.headers.map((h, hi) => (
                                <th key={hi} className="px-4 py-3 text-slate-300 font-medium">
                                  {h}
                                </th>
                              ))}
                            </tr>
